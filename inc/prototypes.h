...
/**  25 */ void		*mremap(void *old_address, size_t old_size, size_t new_size, int flags, ...);
...
/**  56 */ int	   clone(int (*fn)(void *), void *stack, int flags, void *arg, ...);
/**  57 */ pid_t   fork(void);
/**  58 */ pid_t   vfork(void);
...
/** 128 */ int
rt_sigtimedwait(const sigset_t *uthese, siginfo_t *uinfo, const struct _kernel_timespec *uts, size_t sigsetsize);
...
/** 181 */ int	   getpmsg();	  /* Not implemented */
/** 182 */ int	   putpmsg();	  /* Not implemented */
/** 183 */ int	   afs_syscall(); /* Not implemented */
/** 184 */ int	   tuxcall();	  /* Not implemented */
/** 185 */ int	   security();	  /* Not implemented */
...
/** 236 */ int	vserver(); /* Not implemented */
/** 237 */ long
...
/** 248 */ key_serial_t
add_key(const char *type, const char *description, const void *payload, size_t plen, key_serial_t keyring);
/** 249 */ key_serial_t
request_key(const char *type, const char *description, const char *callout_info, key_serial_t dest_keyring);
...
/** 256 */ long
migrate_pages(int pid, unsigned long maxnode, const unsigned long *old_nodes, const unsigned long *new_nodes);
...
/** 310 */ int process_vm_readv(pid_t				pid,
								const struct iovec *lvec,
								unsigned long		liovcnt,
								const struct iovec *rvec,
								unsigned long		riovcnt,
								unsigned long		flags);
/** 311 */ int process_vm_writev(pid_t				 pid,
								 const struct iovec *lvec,
								 unsigned long		 liovcnt,
								 const struct iovec *rvec,
								 unsigned long		 riovcnt,
...
/** 320 */ long
kexec_file_load(int kernel_fd, int initrd_fd, unsigned long cmdline_len, const char *cmdline, unsigned long flags);
...
/** 334 */ int	   rseq(struct rseq *rseq, uint32_t rseq_len, int flags, int32_t sig);
