...
const t_syscall_prototype *syscall_get_prototype(int nr) {
	static const t_syscall_prototype syscalls[] = {
		...
		{   9, 6, "mmap", { "%p", 8 }, { { "%p", 8 }, { "%i", 4 }, { "%i", 4 }, { "%i", 4 }, { "%i", 4 }, { "%li", 8 } } },
		...
		{  44, 6, "sendto", { "%li", 8 }, { { "%i", 4 }, { "%p", 8 }, { "%i", 4 }, { "%i", 4 }, { "%p", 8 }, { "%u", 4 } } },
		{  45, 6, "recvfrom", { "%li", 8 }, { { "%i", 4 }, { "%p", 8 }, { "%i", 4 }, { "%i", 4 }, { "%p", 8 }, { "%p", 8 } } },
		...
		{ 201, 1, "time", { "%li", 8 }, { { "%p", 8 } } },
		{ 202, 6, "futex", { "%li", 8 }, { { "%p", 8 }, { "%i", 4 }, { "%u", 4 }, { "%p", 8 }, { "%p", 8 }, { "%u", 4 } } },
		...
		{ 216, 5, "remap_file_pages", { "%i", 4 }, { { "%p", 8 }, { "%i", 4 }, { "%i", 4 }, { "%i", 4 }, { "%i", 4 } } },
		...
		{ 270, 6, "pselect6", { "%i", 4 }, { { "%i", 4 }, { "%p", 8 }, { "%p", 8 }, { "%p", 8 }, { "%p", 8 }, { "%p", 8 } } },
		...
		{ 298, 5, "perf_event_open", { "%i", 4 }, { { "%p", 8 }, { "%i", 4 }, { "%i", 4 }, { "%i", 4 }, { "%lu", 8 } } },
		...
		{ 303, 5, "name_to_handle_at", { "%i", 4 }, { { "%i", 4 }, { "%p", 8 }, { "%p", 8 }, { "%p", 8 }, { "%i", 4 } } },
		...
		{ 310, 6, "process_vm_readv", { "%i", 4 }, { { "%i", 4 }, { "%p", 8 }, { "%lu", 8 }, { "%p", 8 }, { "%lu", 8 }, { "%lu", 8 } } },
		{ 311, 6, "process_vm_writev", { "%i", 4 }, { { "%i", 4 }, { "%p", 8 }, { "%lu", 8 }, { "%p", 8 }, { "%lu", 8 }, { "%lu", 8 } } },
		...
		{ 320, 5, "kexec_file_load", { "%li", 8 }, { { "%i", 4 }, { "%i", 4 }, { "%lu", 8 }, { "%p", 8 }, { "%lu", 8 } } },
		...
		{ 326, 6, "copy_file_range", { "%li", 8 }, { { "%i", 4 }, { "%p", 8 }, { "%i", 4 }, { "%p", 8 }, { "%i", 4 }, { "%u", 4 } } },
